    ...
    public partial class UniqueUserEmail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("9b2abfba-2451-44d1-9f92-c34e0d6b7413"), "admin@tftic.be", "Admin", new byte[] { 151, 182, 117, 90, 55, 44, 163, 172, 117, 79, 4, 131, 65, 174, 132, 14, 218, 225, 31, 177, 170, 205, 65, 145, 193, 45, 196, 240, 240, 224, 71, 113, 163, 173, 49, 14, 250, 197, 33, 112, 38, 87, 146, 30, 225, 254, 188, 249, 178, 194, 130, 181, 205, 144, 131, 48, 131, 74, 171, 253, 85, 168, 89, 55 }, "Admin" });

            migrationBuilder.InsertData(
                table: "Jeux",
                columns: new[] { "Id", "AnneeSortie", "CreateurId", "DateAjout", "Editeur", "Nom" },
                values: new object[] { new Guid("fcd0fbd4-7cc8-4128-8678-b3989f993245"), 1985, new Guid("9b2abfba-2451-44d1-9f92-c34e0d6b7413"), new DateTime(2023, 10, 6, 12, 15, 14, 130, DateTimeKind.Local).AddTicks(2762), "Nintendo", "Super Mario Bros." });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "Jeux",
                keyColumn: "Id",
                keyValue: new Guid("fcd0fbd4-7cc8-4128-8678-b3989f993245"));

            migrationBuilder.DeleteData(
                table: "Utilisateur",
                keyColumn: "Id",
                keyValue: new Guid("9b2abfba-2451-44d1-9f92-c34e0d6b7413"));
